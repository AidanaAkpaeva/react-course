      ...
      <div className="formbold-input-flex">
        <div>
          ...
          <input
            ...
            name="email"
            id="email"
            className={this.props.contactsError.emailError !== false ? "formbold-form-input" : "formbold-form-input form-error-border"}
        ...
        <div>
          ...
          <input
            ...
            id="phone"
            className={this.props.contactsError.phoneError !== false ? "formbold-form-input" : "formbold-form-input form-error-border"}
